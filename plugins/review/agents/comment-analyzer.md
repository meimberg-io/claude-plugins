...
_Vendored verbatim from [anthropics/claude-plugins-official](https://github.com/anthropics/claude-plugins-official) — `plugins/pr-review-toolkit/agents/comment-analyzer.md`._
